...
export const experienceContent = [
    {        
        id: 1, 
        experience: 'Web Developer at PT. Jago Talenta Indonesia',
        date: 'Dec 2023 - Dec 2024',
        description: 'Developed the Starclick project used by Telkom Indonesia. Responsibilities included migrating from ExtJS to Bootstrap and JavaScript, designing UI elements, consuming APIs, and conducting UI tests using Cypress and unit testing.'
    },
    {
        id: 2, 
